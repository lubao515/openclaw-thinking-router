...
This is an experimental project where I used prompts to have OpenClaw generate the code. Aside from a few minor edits to this README file, all other files were fully generated by OpenClaw based on my suggestions.
